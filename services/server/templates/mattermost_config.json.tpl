{
    ...
    "SqlSettings": {
        "DriverName": "mysql",
        "DataSource": "mmuser:mostest@tcp(${mattermost_db}:3306)/mattermost?charset=utf8mb4,utf8\u0026readTimeout=30s\u0026writeTimeout=30s",
        "DataSourceReplicas": [],
        "DataSourceSearchReplicas": [],
        "MaxIdleConns": 20,
        "MaxOpenConns": 300,
        "Trace": false,
        "AtRestEncryptKey": "kp7aaxcoywm9f85izptiiszettuww338",
        "QueryTimeout": 30
    },
    "LogSettings": {
        "EnableConsole": true,
    ...
    "FileSettings": {
        ...
        "PublicLinkSalt": "q3d9ap746crg1eg54jtojeqx1g4z8erp",
        "ThumbnailWidth": 120,
        "ThumbnailHeight": 100,
        "PreviewWidth": 1024,
        "PreviewHeight": 0,
    ...
    "EmailSettings": {
        ...
        "SMTPPort": "2500",
        "ConnectionSecurity": "",
        "InviteSalt": "s9633qjahmgjdfx8fepsxnk3x1mox7mr",
